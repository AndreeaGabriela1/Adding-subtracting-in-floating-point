...
HD_PWD='D:/Adunarea-si-scaderea-numerelor-in-virgula-mobila-main/SSC_P/SSC_P/SSC_P.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PmodKYPD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PmodKYPD.tcl
